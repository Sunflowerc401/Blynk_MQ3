...
#define IO_USERNAME  "Toandm1303" // Lấy mã Key từ server Adafruit.io
#define IO_KEY       "aio_qYuE72DripYb3ny778fCQxLVOM71"

#define WIFI_SSID "vivo 1723" // Tên wifi để ESP 32 kết nối vào và truy cập đến server.
#define WIFI_PASS "13031990"  // Pass wifi
